...
import com.katalon.testops.core.web.auth.Authentication;
import com.katalon.testops.core.web.auth.HttpBasicAuth;
import com.katalon.testops.core.web.auth.OAuth;
...
@Component("com.katalon.testops.ApiClient")
public class ApiClient {
    private boolean debugging = false;
    private HttpHeaders defaultHeaders = new HttpHeaders();
    private String basePath = "https://analytics.katalon.com";
    ...
    protected void init() {
        ...
        authentications.put("basicScheme", new HttpBasicAuth());
    ...
    public <T> T invokeAPI(String path, HttpMethod method, MultiValueMap<String, String> queryParams, Object body, HttpHeaders headerParams, MultiValueMap<String, Object> formParams, List<MediaType> accept, MediaType contentType, String[] authNames, ParameterizedTypeReference<T> returnType) throws RestClientException {
        ...
        return invoke(url, method, body, headerParams, formParams, accept, contentType, returnType);
    }

    private <T> T invoke(URI url, HttpMethod method, Object body, HttpHeaders headerParams, MultiValueMap<String, Object> formParams, List<MediaType> accept, MediaType contentType, ParameterizedTypeReference<T> returnType) {
        final BodyBuilder requestBuilder = RequestEntity.method(method, url);
        if (accept != null) {
    ...
    public <T> T makeRequest(String url, HttpMethod method, Object body, HttpHeaders headerParams, MultiValueMap<String, Object> formParams, List<MediaType> accept, MediaType contentType, ParameterizedTypeReference<T> returnType) throws RestClientException, URISyntaxException {
        URI uri = new URI(url);
        return invoke(uri, method, body, headerParams, formParams, accept, contentType, returnType);
    }
