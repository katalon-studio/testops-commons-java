...
public class PageBaseResource {
  ...
  private List<BaseResource> content = null;
  ...
  **/
  ...
  public PageBaseResource content(List<BaseResource> content) {
    this.content = content;
    return this;
  }

  public PageBaseResource addContentItem(BaseResource contentItem) {
    if (this.content == null) {
      this.content = new ArrayList<BaseResource>();
    }
  ...
  **/
  @Schema(description = "")
  public List<BaseResource> getContent() {
    return content;
  }

  public void setContent(List<BaseResource> content) {
    this.content = content;
  }
